...
function ciniki_info_contentImageDelete(&$ciniki) {
    ...
    $rc = ciniki_info_checkAccess($ciniki, $args['tnid'], 'ciniki.info.contentImageDelete'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
    ...
    return ciniki_core_objectDelete($ciniki, $args['tnid'], 'ciniki.info.content_image', $args['content_image_id'], $item['uuid'], 0x07);
}
?>
