...
// Binary file.
//
function ciniki_info_contentFileDownload($ciniki) {
    //  
    ...
    $rc = ciniki_info_checkAccess($ciniki, $args['business_id'], 'ciniki.info.contentFileDownload'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
    ...
    if( !isset($rc['file']) ) {
        return array('stat'=>'fail', 'err'=>array('pkg'=>'ciniki', 'code'=>'1667', 'msg'=>'Unable to find file'));
    }
    ...
    if( $rc['file']['extension'] == 'pdf' ) {
        ...
        return array('stat'=>'fail', 'err'=>array('pkg'=>'ciniki', 'code'=>'1666', 'msg'=>'Unsupported file type'));
    }
    // Specify Filename
