//
// The info app to manage donations information
//
function ciniki_info_donations() {
    this.content_type = 6;
    this.init = function() {
        //
        // The panel to display the add form
        //
        this.edit = new M.panel('Donations',
            'ciniki_info_donations', 'edit',
            'mc', 'medium mediumaside', 'sectioned', 'ciniki.info.donations.edit');
        this.edit.data = {};    
...
//              'primary_image_url':{'label':'URL', 'type':'text'},
            ...
            '_content':{'label':'Donations', 'fields':{
                'content':{'label':'', 'type':'textarea', 'size':'large', 'hidelabel':'yes'},
            }},
            '_buttons':{'label':'', 'buttons':{
                'save':{'label':'Save', 'fn':'M.ciniki_info_donations.saveContent();'},
            }},
        };
        ...
        this.edit.addDropImage = function(iid) {
            M.ciniki_info_donations.edit.setFieldValue('primary_image_id', iid, null, null);
            return true;
        };
        ...
        this.edit.rowFn = function(s, i, d) {
            return 'M.ciniki_info_donations.showFileEdit(\'M.ciniki_info_donations.updateFiles();\',M.ciniki_info_donations.edit.content_id,\'' + d.file.id + '\');';
        };
        this.edit.addButton('save', 'Save', 'M.ciniki_info_donations.saveContent();');
    ...
    this.start = function(cb, appPrefix, aG) {
        ...
        // Create container
        //
        var appContainer = M.createContainer(appPrefix, 'ciniki_info_donations', 'yes');
    ...
    this.showEdit = function(cb) {
        M.api.getJSONCb('ciniki.info.contentGet', {'tnid':M.curTenantID,
            'content_type':this.content_type}, function(rsp) {
                ...
                var p = M.ciniki_info_donations.edit;
                p.data = rsp.content;
        ...
        if( c != null ) {
            M.api.postJSONFormData('ciniki.info.contentUpdate', 
                {'tnid':M.curTenantID, 'content_id':this.edit.content_id}, c, function(rsp) {
                    ...
                    M.ciniki_info_donations.edit.close();
                });
        } else {
            this.edit.close();
        }
