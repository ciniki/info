//
// The info app to manage Subscription Agreement information
//
function ciniki_info_subscriptionagreement() {
    this.content_type = 26;
    this.init = function() {
        //
...
//          }},
            '_content':{'label':'Subscription Agreement', 'fields':{
                'content':{'label':'', 'type':'textarea', 'size':'large', 'hidelabel':'yes'},
            }},
            '_buttons':{'label':'', 'buttons':{
                'save':{'label':'Save', 'fn':'M.ciniki_info_subscriptionagreement.saveContent();'},
            }},
        };
        ...
        this.edit.addDropImage = function(iid) {
            M.ciniki_info_subscriptionagreement.edit.setFieldValue('primary_image_id', iid, null, null);
            return true;
        };
        ...
        this.edit.rowFn = function(s, i, d) {
            return 'M.ciniki_info_subscriptionagreement.showFileEdit(\'M.ciniki_info_subscriptionagreement.updateFiles();\',M.ciniki_info_subscriptionagreement.edit.content_id,\'' + d.file.id + '\');';
        };
        this.edit.addButton('save', 'Save', 'M.ciniki_info_subscriptionagreement.saveContent();');
    ...
    this.start = function(cb, appPrefix, aG) {
        ...
        // Create container
        //
        var appContainer = M.createContainer(appPrefix, 'ciniki_info_subscriptionagreement', 'yes');
    ...
    this.showEdit = function(cb) {
        M.api.getJSONCb('ciniki.info.contentGet', {'business_id':M.curBusinessID,
            'content_type':this.content_type}, function(rsp) {
                ...
                var p = M.ciniki_info_subscriptionagreement.edit;
                p.data = rsp.content;
        ...
        if( c != null ) {
            M.api.postJSONFormData('ciniki.info.contentUpdate', 
                {'business_id':M.curBusinessID, 'content_id':this.edit.content_id}, c, function(rsp) {
                    ...
                    M.ciniki_info_subscriptionagreement.edit.close();
                });
        } else {
            this.edit.close();
        }
